...
This repository showcases how to setup a [Chalet](https://www.chalet-work.space) project for the [SFML](https://www.sfml-dev.org/) multimedia framework. It also includes some basic settings for use with [Visual Studio Code](https://code.visualstudio.com/).
